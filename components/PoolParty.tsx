  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', padding: '8px 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
        {[
          ...
          <div key={p.title} style={{
            ...
            <div style={{
              width: '40px', height: '40px', borderRadius: '10px', backgroundColor: p.bg,
              display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', marginBottom: '14px',
            }}>
              {p.icon}
            </div>
            <div style={{ fontSize: '15px', fontWeight: 700, color: '#122023', marginBottom: '6px' }}>{p.title}</div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '16px', fontWeight: 600, color: '#122023', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          Trading Pairs
          <span style={{ backgroundColor: '#E8FDE9', color: '#122023', fontSize: '11px', fontWeight: 600, padding: '4px 10px', borderRadius: '6px' }}>Live</span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {tradingPairs.map((pair) => (
            <div key={`${pair.from}-${pair.to}`} style={{
              display: 'flex', alignItems: 'center', gap: '16px',
              padding: '16px 20px', backgroundColor: '#FAFAFA', borderRadius: '10px',
      ...
      <div style={{
        ...
        <div style={{ fontSize: '16px', fontWeight: 600, color: '#122023', marginBottom: '20px' }}>Liquidity Pools</div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
          {pools.map((pool) => (
            <div key={pool.name} style={{
              ...
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#122023' }}>{pool.name}</div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '16px', fontWeight: 600, color: '#122023', marginBottom: '20px' }}>Why Use Pool Party?</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
