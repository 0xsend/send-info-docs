...
const heroItemIcons = {
  ...
  'send-connect/overview': <HeroIcon name="extension" />,
  ...
  'miscellaneous/whats-new': <HeroIcon name="new_releases" />,
...
export default function DocsLayout({ children, treeData, headings = [] }) {
  ...
  const heroConfigMap = {
    ...
    'send-connect': { image: '/img/theprivacyfirstwallet.png', aria: 'Send Connect - Browser wallet for Canton dApps' },
