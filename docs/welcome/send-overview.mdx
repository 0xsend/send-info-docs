...
* Privacy is non-negotiable. Send pairs the compliance-ready privacy of Canton with transparent Base rails until Send graduates fully onto private infrastructure, giving you control without sacrificing usability.

## What You Get

* **Send:** Built on Base for speed today and evolving toward Canton-backed privacy. Move money instantly, save in stablecoins, and tap rewards—no bank account required.
...
* **Send Safe:** A multisig on Canton Network with passkey security — require multiple approvers on any transfer, with settlement that stays private by default.
...
Global reach and regulatory alignment are built around user sovereignty. Send Safe already delivers fully private transfers, and Send is charting the same path so privacy remains the baseline expectation for modern financial services.
:::
