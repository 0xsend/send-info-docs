...
### **Brandon Young (Managing Partner) - Chief Infrastructure Officer**
...
### **Alexander Mays - Full Stack Engineer**
Full-stack engineer specializing in distributed systems, cloud infrastructure, and product development. Works across the stack with Go, Rust, Kotlin, and TypeScript to build scalable web platforms. Has spent years building multi-cloud compute systems, customer-facing applications, and service mesh architectures. Believes the best code is the code you don't have to write.
