...
**You cannot cancel a withdrawal.** If a release can't be completed, the attestation is revoked and you reclaim your Holding with `BridgeUserAgreement_ReclaimHolding`.
