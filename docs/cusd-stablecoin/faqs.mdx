...
CUSD is a privacy-first, USD-backed stablecoin created by Send, issued by Brale, and backed 1:1 with Frax’s frxUSD. Privacy-first means confidentiality is the default while still allowing compliance when needed.

## What are CUSD’s core privacy features?

- Confidential transfers (transaction amounts and counterparties are private)
- Selective disclosure (share information with auditors or regulators when required)
...
## Who takes fees from CUSD reserve economics?

- Brale: 10% management fee
- Frax: No cut
- Send: Remainder of reserve economics route to the CUSD Treasury for $CC buybacks.
...
Yes. Frax may provide additional rewards to support CUSD growth (details to be announced).
...
- Retail users: Use in-app support within the Canton Wallet (Send app).
- Institutions: Contact Send/Brale through your partnership channel or reach out via the contact options in this docs site.
...
5. How frequently are reserves reported or attested?
6. Will there be transfer or withdrawal fees for CUSD?
7. How do users earn $CC rewards through CUSD usage?
8. What specific form do Frax’s “additional rewards” take?
9. Does Send earn any direct revenue from CUSD aside from ecosystem-level benefits?
10. Are there any jurisdictional restrictions for holding or using CUSD?
