...
:::info New to Canton?
You'll need a Canton Wallet before bridging. See [Canton Wallet → Overview](/docs/send-safe) to get set up with passkeys.
:::
...
- **Send** connected to your **Canton Wallet** ([create one](https://send.cantonwallet.com))
...
- A Canton Wallet ([create one](https://send.cantonwallet.com))
