...
| $SEND balance (min) | Weekly $CC credit |
| ------------------- | ----------------- |
| 2,000               | 1                 |
| 4,000               | 2                 |
| 6,000               | 3                 |
...
Balances above a tier receive the corresponding weekly credit. Higher balances continue to scale in step with the table.
