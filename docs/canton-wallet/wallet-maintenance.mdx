...
To receive the ongoing $CC drip documented in [Canton Rewards](./canton-rewards), a wallet must have transfer pre-approval enabled so incoming credits settle without manual approval.
:::
