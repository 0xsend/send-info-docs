...
- Track your earnings in real-time through Send
...
Your deposited USDC is put to work through established decentralized lending protocols (<a href="https://moonwell.fi/" className="multisig-token-link" target="_blank" rel="noopener noreferrer">Moonwell ↗</a> and <a href="https://morpho.org/" className="multisig-token-link" target="_blank" rel="noopener noreferrer">Morpho ↗</a>) that have been thoroughly tested and secured. These protocols facilitate lending to verified borrowers who pay interest, which is then shared with you as a depositor.
...
- Risk management is handled by industry leaders <a href="https://blockanalitica.com/" className="multisig-token-link" target="_blank" rel="noopener noreferrer">BlockAnalitica ↗</a> and <a href="https://www.bprotocol.org/" className="multisig-token-link" target="_blank" rel="noopener noreferrer">B.Protocol ↗</a>, who collectively advise projects managing over $12 billion in assets
