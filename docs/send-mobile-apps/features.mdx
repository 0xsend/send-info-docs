...
- [Send Links](/docs/features/send-links): Send crypto to anyone using a shareable link — no wallet address needed.
...
Need something else? Head back to the [Send App Overview](/docs/send-mobile-apps/overview) for platform basics and roadmap context.
