...
- [Invest](/docs/features/invest): Review trading fees and mechanics before swapping assets inside Send.
- [Send Verified](/docs/features/verified-profiles): See the requirements for earning Send's trust badge and signaling credibility to other members.

Need something else? Head back to the [Send Overview](/docs/send-mobile-apps/overview) for platform basics and roadmap context.
