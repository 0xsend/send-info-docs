...
**2.** Send iOS and Android Apps  
**3.** Canton Coin Staking ($stCC)  
**4.** Vaults (Canton Wallet multisig)  
**5.** Pool Party (Canton AMM)  
**6.** Send Card - Use a debit card to spend your stables  
**7.** Virtual Accounts - US Bank Account   
