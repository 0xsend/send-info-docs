...
<ol>
  <li>Consistently improving the onboarding, UX, and our rewards program</li>
  <li>iOS and Android Apps</li>
  <li>Send Safe (secure multi-signature asset storage)</li>
  <li>Pool Party (AMM DEX on Canton Network)</li>
  <li>Staking (for CC and SEND)</li>
</ol>
...
### 2025
**19.** CUSD (Privacy-first stablecoin) - *11/25*  
