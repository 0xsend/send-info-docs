...
## Sendtag
A human-readable username that maps to a Send wallet address, enabling payments without sharing long hexadecimal strings. Sendtags simplify payments across both Send and partner experiences.
